...
<body>
	...
	<div align="right">
	<a class="btn back-btn" href="user.php" >HOME</a>
	</div>
        ...
        <section class="view-img-container">
            <div class="card-container">
                ...
                while($image = mysqli_fetch_array($get_image)){
                    echo "<div class='card' ><div class='card-image' ><a href='View-Image-Big.php?title-id=".$_GET['title-id']."'><img src='".$image['image']."'  alt='Gallery Image' class='image' style='filter:grayscale(0%)' id='myImg' /></a></div><div class='card-download'><a href='".$image['image']."' class='download-btn' download>Download</a></div></div>";
				}
                ?>
        </div>
        </section>
